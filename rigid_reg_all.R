...
for (i in sub_list) {  
  ...
  m1=paste("mi[",path_to_cpb,"lhtemplate0.nii.gz,",path_to_cpb,i,"-lab.nii.gz, 1, 32,Regular, 0.25]",sep="")
  m2=paste("mi[",path_to_cpb,"lhtemplate0.nii.gz,",path_to_cpb,i,"-t1.nii.gz, 1, 32,Regular, 0.25]",sep="")
  m3=paste("mi[",path_to_cpb,"lhtemplate0.nii.gz,",path_to_cpb,i,"-t2s.nii.gz, 1, 32,Regular, 0.25]",sep="")
  
  #set output path and file pre-fix
  output=paste(path_to_dz,"lh",i,"-30",sep="")
